...
/usr/local/bin/minimap2 -ax splice -uf -k14 --secondary=no --MD $config_input_files_reference_genome_norm $config_input_files_fastq_file > $config_input_files_map_file
